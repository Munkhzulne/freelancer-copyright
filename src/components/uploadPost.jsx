...
export const UploadPost = () => {
  ...
  const { user } = useUser()
  const checkSimiliarPictires = hashValue => {
    return new Promise(function (resolve, reject) {
      _.forEach(photos, ({ hash }) => {
        if (hash.length === hashValue.length) {
          let count = 0
          for (let i = 0; i <= hash.length; i++) {
            if (hash.toLowerCase()[i] !== hashValue.toLowerCase()[i]) {
              count++
            }
          }
          if (count <= 10) {
  ...
  return (
    <>
      ...
      >
         Таны нийтлэлдээ хавсаргах гэсэн зурагтай адилхан эсвэл төстэй зургийг өөр нэг хэрэглэгч хийсэн ажилдаа оруулсан байна. 
        <Typography.Text type="success"> Манай систем зохиогчийн эрхийг хамгаалдаг </Typography.Text>тул хэн нэгний хийсэн бүтээлийг хуулбарлаж өөрийн ажилдаа оруулахыг хориглодог.
        Хэрэв багаар ажилласан болон энэхүү зураг таны өөрийн өмч мөн бол <Typography.Text type="success"> шалгуулах</Typography.Text>  боломжтой.
      </Modal>
      <Card
